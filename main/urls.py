...
from main.views import create_product_ajax, update_product_ajax, delete_product_ajax, login_ajax, register_ajax
...
urlpatterns = [
    ...
    path('create-product/', add_product, name='create_product'),
